...
import '../../lib/swiper-4.2.6.min.css';
...
class Details extends React.Component{
    ...
    componentDidMount(){  
        ...
        Requests.ajax({
            ...
            new Swiper('.watch-zoom .swiper-container', {
                ...
                // 如果需要分页器
                pagination: {
                  el: '.watch-zoom .swiper-pagination',
                },
            ...
            Requests.ajax({
                ...
                if(res.body.msg === 'auth'){
                    ...
                    this.props.history.push({
                        "pathname":"/login",
                        "state":{
                            "temppathname":this.props.location.pathname,
                            "tempsearch":this.props.location.search
                        }
                    })
                }
            });
                ...
                <div className="swiper-container">
                    <div className="swiper-wrapper">
                        <div className="swiper-slide">
                            <img src={this.state.data.infos ? this.state.data.infos.img : null} alt="" />
                        </div>
                        <div className="swiper-slide">
                            <img src="https://static.jiaoyimao.com/resource/public/goodsinfo/2018/5/12/b7dfddd9-82a5-46d0-825b-97bb00fbb171.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                            <img src="https://static.jiaoyimao.com/resource/public/goodsinfo/2018/5/14/c7b0a2b1-8370-4c0f-893c-8c727c9717dd.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                            <img src="https://static.jiaoyimao.com/o/gcmall/3tGrA/;;0,gcmall/g/resource/public/goodsinfo/2018/4/1/48087e78-5365-47f2-9189-d344087dd4ba.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                            <img src="https://static.jiaoyimao.com/resource/public/goodsinfo/2018/5/12/b7dfddd9-82a5-46d0-825b-97bb00fbb171.jpg" alt="" />
                        </div>
                    ...
                    <div className="image-zoom-security-tips">
                        <i className="icon-imagezoom-security" style={collect}></i>
                        如有联系方式均为骗子，请勿上当
                    </div>
                </div>
            </div>
