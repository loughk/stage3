        ...
        if(this.refs.zcbtn.style.background==='red'){
                ...
                if(res.body.status){
                    ...
                    if(this.props.location.state){
                        ...
                        if(this.props.location.state.temppathname){
                            obj.pathname = this.props.location.state.temppathname;
                        }
                        if(this.props.location.state.tempsearch){
                            obj.search = this.props.location.state.tempsearch;
                        }
                        if(this.props.location.state.tempstate){
                            obj.state = this.props.location.state.tempstate;
                        }
            ...
            <div className="jym_register flexbox ">
                <div className="container">
                    <div className="header">
                        <div className="close-dl" onClick={this.toback}></div>                        
                    </div>
